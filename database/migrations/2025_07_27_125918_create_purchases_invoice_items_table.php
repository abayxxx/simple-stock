...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('purchases_invoice_items', function (Blueprint $table) {
            ...
            $table->decimal('sub_total_sblm_disc', 20, 2)->default(0)->nullable();
            $table->decimal('total_diskon_item', 20, 2)->default(0)->nullable();
            $table->decimal('sub_total_sebelum_ppn', 20, 2)->default(0)->nullable();
            $table->decimal('ppn_persen', 5, 2)->default(0)->nullable();
            $table->decimal('sub_total_setelah_disc', 20, 2)->default(0)->nullable();
