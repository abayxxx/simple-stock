...
<h1>Detail Pembayaran Penjualan</h1>
@stop
...
<div class="card">
    <div class="card-body">
        <div class="row mb-3">
            ...
            <div class="col-md-4"><b>Customer:</b> {{ $payment->customer->name ?? '-' }}</div>
        </div>
        <div class="row mb-3">
        ...
        <div class="mt-4">
            <a href="{{ route('sales.payments.index') }}" class="btn btn-secondary">Kembali</a>
        </div>
    </div>
</div>
@stop