...
@section('title', 'Faktur Penjualan Detail')
...
.group-header-green { background: #B7F5BF !important; font-weight: bold; color: #000; }
.group-header-yellow { background: #FFFCC1 !important; font-weight: bold; color: #000; }
.group-item-yellow   { background: #FFFCC1 !important; }
.subtotal-row { background: #efefef !important; font-weight: bold; }
.grand-total-footer { background: #f8f8f8 !important; font-weight: bold; font-size: 1.07em; }
...
$(function(){
    let table = $('#faktur-detail-table').DataTable({
        ...
        columns: [
            { data: 'faktur_no', name: 'faktur_no' },  // group NO.
            ...
            { data: 'disc_1', name: 'disc_1', className:'text-right' },
            { data: 'disc_2', name: 'disc_2', className:'text-right' },
        ...
        drawCallback: function(settings){
            ...
            let lastGroup = null;
            let subtotalQty = 0, subtotalDisc1 = 0, subtotalDisc2 = 0, subtotalSubtotal = 0;
            let grandQty = 0, grandDisc1 = 0, grandDisc2 = 0, grandSubtotal = 0;
            ...
            data.each(function(row, i){
                ...
                if (lastGroup !== group) {
                    ...
                    // Reset subtotal
                    subtotalQty = 0; subtotalDisc1 = 0; subtotalDisc2 = 0; subtotalSubtotal = 0;
                }
