...
class PurchasesUnpaidExport implements FromCollection, WithHeadings, WithEvents, ShouldAutoSize
{
    protected $request;
    protected $data;
    protected $grouped;
    ...
    public function collection()
    {
        ...
        if ($this->request->supplier) {
            $query->whereHas('supplier', function($q) {
                $q->where('name', 'like', '%' . $this->request->supplier . '%');
            });
        }
